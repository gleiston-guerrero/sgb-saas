...
con efectos secundarios. Tras la limpieza de cierre, el conteo estático
del backend queda en 13 apariciones de \texttt{@Procedure}/
\texttt{@NamedStoredProcedureQuery} y 37 apariciones de
\texttt{nativeQuery = true}; las variantes nativas obsoletas de
\texttt{ReservationProcedureRepository} fueron retiradas y la expiración
de reservaciones usa solo el método \texttt{@Procedure} que invoca el
\emph{scheduler}.
