...
\begin{itemize}[leftmargin=1.2cm]
  \item \textbf{Cajas}: autor del mayor volumen de commits del proyecto
    (715 commits humanos sin merges según
    \texttt{git -c log.mailmap=true shortlog -sne --no-merges HEAD}),
  ...
  \item \textbf{Loor}: autor de la mayoría de los commits de
    ...
    merges según la misma consulta con \texttt{.mailmap}.
  \item \textbf{Panamá}: autor de los componentes de frontend de
    ...
    \texttt{.mailmap}. Asignado a la ejecución de las pruebas SUS
    pendientes (OBS-08, \autoref{sec:tf-sus}).
\end{itemize}
