...
artefactos declaran \textbf{87,41\,\%} de líneas (1805/2065) y
\textbf{76,19\,\%} de ramas (448/588). Esta es la única cifra vigente de
...
sobre la totalidad del código analizado (49 clases en la corrida
...
\midrule
Lines & 1805/2065 & \textbf{87,41\,\%} & $\geq$70\,\% \textbf{Sí} \\
Branches & 448/588 & \textbf{76,19\,\%} & $\geq$70\,\% \textbf{Sí} \\
\bottomrule
\end{tabular}
...
analizables cerró en 2065 líneas tras las exclusiones JaCoCo documentadas, con los commits
posteriores al merge de los 8 módulos (nuevos controladores, chatbot,
auditoría, QR, backups, sugerencias de adquisición, etc.) y los
procedures nativos agregados para la estrategia híbrida de acceso a
datos (ver \texttt{docs/basedatos/CATALOGO-SP.md}), y la
cobertura global de líneas supera el \textbf{umbral informal de 70\,\%}
fijado por el equipo para la Entrega Final (87,41\,\% al cierre). Las
capas \texttt{controller} (97,03\,\% líneas, 75,51\,\% ramas),
\texttt{security}, \texttt{scheduling} y \texttt{service} (87,38\,\%
líneas, 77,70\,\% ramas) quedan por encima del umbral interno en líneas
y ramas; las ramas globales cierran en 76,19\,\% y cumplen el umbral de
