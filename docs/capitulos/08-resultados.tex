...
artefactos declaran \textbf{87,77\,\%} de líneas (1787/2036) y
\textbf{76,03\,\%} de ramas (441/580). Esta es la única cifra vigente de
...
\midrule
Lines & 1787/2036 & \textbf{87,77\,\%} & $\geq$70\,\% \textbf{Sí} \\
Branches & 441/580 & \textbf{76,03\,\%} & $\geq$70\,\% \textbf{Sí} \\
\bottomrule
\end{tabular}
...
fijado por el equipo para la Entrega Final (87,77\,\% al cierre). Las
capas \texttt{controller} (95,54\,\% líneas, 70,41\,\% ramas),
\texttt{security}, \texttt{scheduling} y \texttt{service} (87,38\,\%
líneas, 77,70\,\% ramas) quedan por encima del umbral interno en líneas
y ramas; las ramas globales cierran en 76,03\,\% y cumplen el umbral de
...
\textbf{Interpretación por capa (vigente al cierre, \autoref{tab:res-jacoco-capas-vigente}).} La medición vigente deja \texttt{controller} por encima del umbral interno (95,54\,\% de líneas; 70,41\,\% de ramas) y \texttt{service} cruza el umbral en líneas (87,38\,\%) y ramas (77,70\,\%). El detalle numérico queda en el XML versionado para evitar mezclar cifras de cierre con cifras históricas dentro del texto defendido.
...
3. Cobertura (JaCoCo) & Medición vigente de cierre: 87,77\,\% de líneas (1787/2036) y 76,03\,\% de ramas (441/580), respaldada por el XML versionado; cumple el objetivo interno de 70\,\% en líneas y ramas, con servicios (87,38\,\%/77,70\,\%) y controladores (95,54\,\%/70,41\,\%) sobre el umbral & \textbf{Completo} & Sí \\
