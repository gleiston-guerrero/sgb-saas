...
participantes que exige la guía. La corrida SUS previa queda retirada
como evidencia empírica por falta de trazabilidad a un export crudo del
instrumento y por ausencia de consentimientos versionables/verificables
sin exponer datos personales. Por esa razón, este informe no publica
ningún archivo de respuestas, cifra agregada, tabla descriptiva ni figura
derivada de SUS; solo conserva el protocolo y el instrumento para una
corrida futura.
...
\textbf{Estado real.} \textbf{Pendiente / retirado como resultado.} La
toma de datos con usuarios y el protocolo SUS se difieren formalmente
como trabajo futuro para la fase de despliegue en producción
(\autoref{sec:tf-sus}). Documentado como reabierto en \texttt{OBS-08} de
\texttt{docs/observaciones/OBSERVACIONES.md}. Este bloque queda cerrado
sin evidencia SUS evaluable: no hay consentimientos firmados versionados,
no hay export crudo del instrumento y no hay conclusión de usabilidad.
