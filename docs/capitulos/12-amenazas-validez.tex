...
anómala en \texttt{cache\_caliente} (p95$=$129{,}63\,ms, frente a un
rango de 31{,}16--41{,}57\,ms en las 4 corridas siguientes) que no se
...
La amenaza de validez externa más relevante en este bloque es el alcance
de la evidencia de usabilidad (System Usability Scale, SUS). La guía
exige un mínimo de $N\geq15$ participantes y se alcanzó una muestra de
$N=15$ (\autoref{sec:res-usabilidad}), pero se reclutó \textbf{por
conveniencia dentro de la comunidad UTEQ}, no de forma aleatoria ni fuera
de ese contexto
...
perfil de este estudio SUS -- limitan severamente la
...
representativo de una población más amplia sin justificarlo. Los datos
publicados usan códigos anónimos, mientras que el consentimiento y las
identidades permanecen privados. La autorización adicional para publicar
filas anónimas se comunicó oralmente de forma grupal, no como segunda firma
escrita; por ello la reproducibilidad pública no sustituye una futura
validación con muestreo más diverso (\autoref{sec:tf-sus}).
...
grande y consistente (Cliff's delta $=-1{,}00$). Tratar este resultado
