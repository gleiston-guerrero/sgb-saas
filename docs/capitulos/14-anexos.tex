...
\textbf{87,77\,\%} de líneas (1787/2036) y \textbf{76,03\,\%} de ramas
(441/580), medida con JaCoCo sobre el corte de cierre
...
queda pendiente hasta disponer de participantes, consentimiento
informado trazable y export crudo del instrumento. No se conserva ningún
archivo de respuestas, figura ni cifra SUS como evidencia empírica de
usuarios reales.

Las figuras evaluables del informe quedan rotuladas en inglés: los tres
diagramas C4, el DER y el gráfico de rendimiento p95 usan labels/captions
en inglés; las figuras SUS anteriores se retiraron junto con los datos no
trazables.
