...
ZAP), JaCoCo, Lighthouse, y una ejecución SUS con 15 participantes
adultos, consentimiento privado y export anonimizado. Ambos umbrales p95 se cumplen con
margen amplio ($65{,}60$/$17{,}13$\,ms, bajo $200$/$500$\,ms); de
...
alcanza $86{,}30$\,\% de líneas (2337/2708) y $74{,}53$\,\% de ramas
(594/797) sobre 655
pruebas de backend, y 23 de los 26~requisitos
\texttt{Must} (71 totales) tienen verificación real. La muestra de
usabilidad ($N=15$) obtuvo una media SUS de $66{,}00$ (IC95\%:
$56{,}95$--$75{,}05$); es una muestra por conveniencia y no se presenta
como representativa. SGB-SaaS
...
proceso genuino; los límites de generalización de la muestra y los
hallazgos de experiencia de usuario quedan declarados como trabajo futuro, no
ocultados.
...
(SUS) run with 15 adult participants, private consent, and an anonymized export. Both p95
latency thresholds are met with a wide margin (65.60~ms and 17.13~ms,
...
triage; JaCoCo coverage reaches 86.30\% of lines (2337/2708) and 74.53\% of
branches (594/797) across 655~backend tests, and 23 of the
26~\texttt{Must}-priority
requirements (71~total) carry real verification. The usability sample
($N=15$) produced a mean SUS score of 66.00 (95\% CI: 56.95--75.05);
it is a convenience sample and is not presented as population-representative.
SGB-SaaS meets its performance and coverage thresholds with
a solid margin; its security audit, with real findings fixed, confirms
a genuine process; the sample's generalization limits and user-experience
findings are explicitly declared as future work rather than
hidden.
