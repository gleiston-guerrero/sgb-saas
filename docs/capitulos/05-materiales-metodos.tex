...
\begin{itemize}[leftmargin=1.2cm]
  ...
  \item \textbf{JaCoCo} (\texttt{jacoco-maven-plugin} en
    ...
    vigente es \textbf{87,77\,\%} de líneas (1787/2036) y \textbf{76,03\,\%}
    de ramas (441/580) — medición en fresco sobre
    \texttt{fix/correciones} con exclusiones documentadas en
