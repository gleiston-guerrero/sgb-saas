...
\begin{enumerate}[leftmargin=1.4cm]
  ...
  \item \textbf{Evaluación.} El conjunto de instrumentos de medición
    ...
    (k6, JaCoCo, Lighthouse, auditoría OWASP y SUS ejecutado con
    $N=15$ participantes).
...
\begin{itemize}[leftmargin=1.2cm]
  \item \textbf{System Usability Scale (SUS)} \citep{brooke1996sus}: 10
    ...
    instrumento del Bloque~C.3 de esta guía; su ejecución y sus límites
    de muestreo se declaran con honestidad en la
  ...
  \item \textbf{JaCoCo} (\texttt{jacoco-maven-plugin} en
    ...
    vigente es \textbf{86,30\,\%} de líneas (2337/2708) y \textbf{74,53\,\%}
    de ramas (594/797) — medición en fresco sobre
    \texttt{main} con exclusiones documentadas en
...
\textbf{Nota de honestidad -- ejecución y alcance.} El 19-sep-2026 se
cerró una muestra por conveniencia de $N=15$ participantes adultos. Cada
persona aceptó el consentimiento del formulario privado; los identificadores
personales quedan bajo custodia y el repositorio publica únicamente códigos
\texttt{P01}, \ldots, \texttt{P15} y respuestas anonimizadas. La media
recalculada es $66{,}00$ (IC95\%: $56{,}95$--$75{,}05$), pero la muestra no
es aleatoria ni representa a toda la población UTEQ. La autorización oral
grupal para publicar filas anonimizadas fue comunicada por el responsable de
la difusión y se documenta como tal; no se presenta como una segunda firma
individual escrita. El instrumento, manifest de custodia y cálculo están en
...
Wilcoxon $p=0{,}0625$, Cliff's delta $=-1{,}00$ -- y su interpretación
