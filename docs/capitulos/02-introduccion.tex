...
\begin{itemize}[leftmargin=1.2cm]
  ...
  \item Un artefacto de software citable con identificador persistente:
    ...
    (\texttt{10.5281/zenodo.22741050} para la versión \texttt{v1.0.1},
    generado el 2026-09-14 a partir del Release de GitHub sobre el tag
    \texttt{v1.0.1}; sucede al registro de \texttt{v1.0.0}, que dejó de
    resolverse en doi.org — ver portada).
