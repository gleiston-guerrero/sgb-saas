...
\section{Evidencia de usabilidad (SUS, $N=15$) -- CERRADO}
\label{sec:tf-sus}

El Bloque~5 queda cerrado con una corrida de $N=15$ aplicada el 19 de
septiembre de 2026. El instrumento, CSV anónimo, manifiesto de
consentimientos, script de recálculo y figuras se encuentran en
\texttt{docs/mediciones/sus/}. La media resultante es 66,00/100 con
IC~95\,\% [56,95; 75,05]; el informe no generaliza el resultado de esta
muestra de conveniencia. Como mejora futura quedan las incidencias que
reportaron participantes: rendimiento de carga, visibilidad del acceso y
salida de sesión, y búsqueda del catálogo.

\section{Cerrar cobertura de ramas en servicios -- CERRADO}
\label{sec:tf-service-branch-coverage}

La medición JaCoCo vigente deja \texttt{service} por encima del umbral
tanto en líneas (87,55\,\%, 1266/1446) como en ramas (77,31\,\%,
351/454), y \texttt{controller} en 96,54\,\%/75,51\,\%, según el XML
versionado en \texttt{docs/mediciones/jacoco/report.xml} (corrida
\texttt{mvnw clean verify} con 655 tests, 0 fallos). El objetivo de la
rúbrica (70\,\% en líneas y ramas de servicios y controladores) queda
cumplido en esta entrega; como mejora continua se mantiene la vigilancia
de ramas en los reportes de cierre.
