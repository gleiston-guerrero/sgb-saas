...
$65{,}60$\,ms contra un límite de $200$\,ms en caché caliente, p95
$17{,}13$\,ms contra $500$\,ms en frío
...
\texttt{cache\_caliente}: Cliff's delta $=-1{,}00$ (grande, consistente en
las 5 corridas), exactamente la dirección que la hipótesis de caché
predeciría si la comparación fuera limpia; el Wilcoxon pareado da
$p=0{,}0625$, no significativo por potencia ($n=5$, mínimo exacto
alcanzable), no por falta de efecto. En síntesis: RQ1 se responde
...
RQ3 cuenta ahora con una respuesta descriptiva y acotada. La muestra por
conveniencia de $N=15$ participantes adultos obtuvo una media SUS de
$66{,}00$ (mediana $67{,}50$, IC95\%: $56{,}95$--$75{,}05$), con 13 tareas
completadas y 2 parcialmente completadas. Esto sugiere una experiencia
usable pero con margen claro de mejora; los comentarios reportan lentitud,
acceso y búsqueda como puntos a priorizar. No se infiere aceptación de toda
la comunidad UTEQ: el reclutamiento no fue aleatorio y la autorización de
publicación de filas anonimizadas fue oral y grupal, limitaciones documentadas
en \autoref{sec:res-usabilidad}.
...
que requiere cautela antes de una decisión de adopción informada es la
evidencia de usabilidad percibida por usuarios reales (RQ3): existe una
muestra por conveniencia de $N=15$, pero no un estudio representativo.
Una institución que considere este sistema debería tratar
...
hallazgos de usabilidad (SUS) como base para priorizar mejoras y validar
de nuevo con una muestra más diversa.
