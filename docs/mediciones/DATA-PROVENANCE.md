...
| 16 | `tab:res-sus-items`, `fig:res-sus-scores`, `fig:res-sus-items` y resultado SUS | 08-resultados.tex, §Usabilidad | `docs/mediciones/sus/sus.csv` (15 filas anónimas), instrumento y manifiesto de consentimientos privados por código | `scripts/analyze-sus.py` recalcula Brooke, IC~95\,\% y genera las figuras; `scripts/verify-p3-sus.py` contrasta CSV, manifiesto, SHA-256 y derivados | Corrida 2026-09-19; la huella del CSV y las estadísticas derivadas constan en `sus-statistics.json`. |
